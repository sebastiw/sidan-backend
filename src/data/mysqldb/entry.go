...
func (d *MySQLDatabase) ReadEntriesWithFilter(take int, skip int, filterQuery string, viewerMemberID *int64) ([]models.Entry, error) {
	return d.CommonDB.ReadEntriesWithFilter(take, skip, filterQuery, viewerMemberID)
}
